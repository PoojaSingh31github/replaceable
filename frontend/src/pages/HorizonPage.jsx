      ...
      <section className="hero">
        ...
        <div className="hero-content">
          <div className="hero-text">
            <h1>
              Mapping <em>Tomorrow's</em> Workforce, Today
            </h1>
            <p className="hero-subtitle">
              We don't predict the future—we model the forces reshaping it.
              Rigorous scenario analysis meets proprietary role intelligence to
              illuminate the paths ahead.
            </p>
            <div className="hero-distinction">
              <strong>Not Forecasting. Foresighting.</strong>
              <span>
                A fundamentally different approach to workforce strategy
              </span>
            </div>
